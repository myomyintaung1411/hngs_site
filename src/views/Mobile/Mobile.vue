<template>
  <div style="width: 100%; height: 100%; background: #2b2b32">
    ...
    <div class="area two" ref="block2">
      <div class="area-bg">
        ...
        <div class="header-group">
          <h3>全真人实景娱乐厅</h3>
          <p>
            真实现场，全真人发牌，美女荷官，24小时实时验证，可来实体现场，公司专人接送，请联系官方客服，报销机票，包食宿，给您帝王般的享受。
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="scroll_div">
      <div class="float-title">
        <span class="icon-imgs"
          ><img
            src="https://img2.54ei.com/hn/index/imgs/language.png"
            alt="" /><i style="background: rgb(255, 75, 0)"></i
        ></span>
        <div>
          <h5>支持多语言</h5>
          <p>全球畅玩，多语言支持</p>
    ...
    <div class="scroll_div">
      <div class="float-title">
        <span class="icon-imgs"
          ><img src="https://img2.54ei.com/hn/index/imgs/chip.png" alt="" /><i
            style="background: rgb(255, 75, 0)"
          ></i
        ></span>
        <div>
          <h5>HN casino</h5>
    ...
    <!-- footer -->
    <div id="footer">
      <p>COPYRIGHT © HUANA INTERNATIONAL RESERVED.</p>
    </div>
  </div>
</template>
